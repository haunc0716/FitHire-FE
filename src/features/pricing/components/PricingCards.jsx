...
const PLAN_THEMES = {
  FREE: {
    ...
    cardClass: 'bg-white border-zinc-200',
    iconWrapClass: 'bg-zinc-100',
    iconClass: 'text-slate-500',
    priceClass: 'text-slate-600',
    modelClass: 'bg-zinc-100 text-slate-600',
    checkWrapClass: 'bg-zinc-100',
    checkClass: 'text-slate-500',
    ctaClass: 'bg-zinc-100 text-zinc-700 border-zinc-200 hover:bg-zinc-200',
  ...
  LUOT_LE: {
    ...
    modelClass: 'bg-cyan-50 text-cyan-700',
    checkWrapClass: 'bg-cyan-50',
  ...
  PRO: {
    ...
    cardClass: 'bg-gradient-to-b from-white to-teal-50/50 border-teal-500 shadow-[0_20px_60px_-30px_rgba(13,148,136,0.65)]',
    iconWrapClass: 'bg-teal-100',
    iconClass: 'text-teal-700',
    priceClass: 'text-teal-700',
    modelClass: 'bg-teal-100 text-teal-700',
    checkWrapClass: 'bg-teal-100',
    checkClass: 'text-teal-600',
    ctaClass: 'bg-gradient-to-r from-teal-600 to-teal-400 text-white border-transparent hover:from-teal-500 hover:to-teal-300',
